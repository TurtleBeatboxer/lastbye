...
import { registeration, registeration1 } from './register.model';
...
export class RegisterService {
  ...
  save(registration: registeration): Observable<{}> {
    return this.http.post(this.applicationConfigService.getEndpointFor('api/register'), this.changeRegistration(registration));
  }
